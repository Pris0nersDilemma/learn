window.onload = function(){
    function cart(){
        ...
        this.ogood_num = document.querySelector('.goods_num');//商品数量
        this.opricetal = document.querySelector('.pricetal');//共计价钱
        this.opricest = document.querySelector('.pricest');//最贵单价
        this.totalnum = 0;//记录商品数量
    };
     //小计:  商品数量 * 商品单价
